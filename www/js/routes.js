...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('availableCarForRenting', {
    url: '/availableCar',
    templateUrl: 'templates/availableCarForRenting.html',
    controller: 'availableCarForRentingCtrl'
  })
  ...
  .state('myRentalRecord', {
    url: '/RentalRecord',
    templateUrl: 'templates/myRentalRecord.html',
    controller: 'myRentalRecordCtrl'
  })
